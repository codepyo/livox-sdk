...
g = 9.8
x = 9.8 * math.sin(0.142)
y = 0
z = -9.8 * math.cos(0.142)
...
for point in range(floor.size):
    ...
    #### process something
    if x > 3 and x < 4 and y > -0.5 and y < 0.5:
        cloud_arr[point][0] = 0
        cloud_arr[point][1] = 0
        cloud_arr[point][2] = 0

print(cloud_arr)
floor.from_array(cloud_arr)
#--------------------------------------

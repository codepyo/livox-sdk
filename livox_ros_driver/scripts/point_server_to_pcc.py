...
def on_message(client, userdata, msg):  # The callback for when a PUBLISH message is received from the server.
    ...
    data = str("Message received-> " + msg.topic + " " + str(msg.payload))
...
class rpScanReceiver():
    ...
    def callback(self, input_ros_msg):
        ...
        #f = open("newfile.txt", 'w')
        #data = str(service_mqtt_client._paho_mqtt)
...
if __name__=="__main__":
    ...
    logins = login_mqtt()
    topic_class='lidar'
    service_topic = 'wlogs/device/service/wlogs:kor:wlogsORG:embedded-sg20:137fcf3c-70b7-4b81-835e-c64518dab3fc:1659489367.16211/lidar/skv1/pointcloud/4'
    service_mqtt_client = mqtt_data_client(logins, topic_class)
    client_id = logins.clientID

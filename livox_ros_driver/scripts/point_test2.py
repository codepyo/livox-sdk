...
def sheet_array_to_pointcloud2(cloud_arr, stamp=None, frame_id=None):
...
class rpScanReceiver():
    ...
    def __init__(self):
        ...
        self.image_pub = rospy.Publisher("/out2", PointCloud2, queue_size=1)
        rospy.spin()
